...
#define	EXT0_HOTEND_TYPE_1			1
#define	EXT0_HOTEND_TYPE_2			2
#define	EXT0_HOTEND_TYPE_3			3
#define	EXT1_HOTEND_TYPE_1			1
#define	EXT1_HOTEND_TYPE_2			2
#define	EXT1_HOTEND_TYPE_3			3
...
#if EXT0_HOTEND_TYPE == EXT0_HOTEND_TYPE_1
...
#if EXT0_HOTEND_TYPE == EXT0_HOTEND_TYPE_2
	/** \brief The maximum value, I-gain can contribute to the output. Overridden if EEPROM activated. */
	#define EXT0_PID_INTEGRAL_DRIVE_MAX 130
...
#if EXT0_HOTEND_TYPE == EXT0_HOTEND_TYPE_3
	/** \brief The maximum value, I-gain can contribute to the output. Overridden if EEPROM activated. */
...
#define EXT1_WATCHPERIOD 10
...
#if EXT1_HOTEND_TYPE == EXT1_HOTEND_TYPE_1
	/** \brief The maximum value, I-gain can contribute to the output. Overridden if EEPROM activated. */
...
#endif // EXT1_HOTEND_TYPE == EXT1_HOTEND_TYPE_1

#if EXT1_HOTEND_TYPE == EXT1_HOTEND_TYPE_2
	/** \brief The maximum value, I-gain can contribute to the output. Overridden if EEPROM activated. */
	#define EXT1_PID_INTEGRAL_DRIVE_MAX 130
	...
	/** P-gain.  Overridden if EEPROM activated. */
	#define EXT1_PID_P   7.89

	/** I-gain. Overridden if EEPROM activated. */
	#define EXT1_PID_I   1.78

	/** Dgain.  Overridden if EEPROM activated.*/
	#define EXT1_PID_D 8.77
#endif // EXT1_HOTEND_TYPE == EXT1_HOTEND_TYPE_2

#if EXT1_HOTEND_TYPE == EXT1_HOTEND_TYPE_3
	/** \brief The maximum value, I-gain can contribute to the output. Overridden if EEPROM activated. */
...
#endif // EXT1_HOTEND_TYPE == EXT1_HOTEND_TYPE_3
